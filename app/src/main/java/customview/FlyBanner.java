...
public class FlyBanner extends RelativeLayout {
    ...
    //指示点资源
    private int mPointDrawableResId = R.drawable.selector_indicator_version_4;
    //指示容器背景
    ...
    private class FlyPageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            View view = LayoutInflater.from(getContext()).inflate(R.layout.item_recommend_index, container, false);
            ImageView imageView = (ImageView) view.findViewById(R.id.iv_recommend_index);
